          ...
          <div class="col-md-12">
            <form action="<?= site_url('equipo/getData') ?>" method="POST">
              ...
              <div class="form-group">                
                ...
                <div class="custom-control custom-checkbox custom-control-inline">
                  <input type="checkbox" class="custom-control-input" id="email" name="dato[administrativos_email]">
              ...
              <input type="hidden" id="parternType" name="parternType" value="administrativos">
